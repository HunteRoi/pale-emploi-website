<footer class="vw-100 footer mt-auto py-3 px-3 border-top d-flex flex-wrap justify-content-between align-items-center bg-dark navbar navbar-expand-lg navbar-dark">
    ...
    <ul class="navbar-nav col-md-4 justify-content-end list-unstyled d-flex">
