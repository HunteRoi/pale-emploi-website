...
<div class="container container-sm d-flex justify-content-center">
            ...
            <div class="css-srfrud e1gufzzf0">
                <div class=" css-1kbtny3 e37uo190">
                    <div class="css-1e9y1g e37uo190">
                        <div class="css-1epf9yb eu4oa1w0">
                    ...
                    <div class="css-x02f3 eu4oa1w0"><input aria-label="Upload Resume" data-testid="file-upload-input"
                                                           type="file" style="display: none; visibility: hidden;"
                        ...
                        <button aria-haspopup="true" aria-controls="menu--4"
                                ...
                                data-tn-variant="element" data-tn-action-click="true"
                                class="e8ju0x50 css-hmfc7m ex6cvhv1"
                                id="menu-button--menu--4" type="button" data-reach-menu-button="">
                            <svg
    ...
    <section class="container">
        ...
        <a id="sponsor_btn" class="btn btn-primary mt-3"
           href="/?page=employee/become_employer">Devenir employeur</a>
    </section>
</div>
